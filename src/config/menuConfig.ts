...
export const MENU_CONFIG: MenuConfigEntry[] = [
  ...
  { macroTitle: 'Administrativo' },
  {
    ...
    items: [
      ...
      { label: 'Dispositivos RH', path: '/rh-agent/dispositivos', icon: 'Cpu', feature: 'RH_AGENT.VIEW', requireGestor: true },
    ],
  },
  {
    section: 'rhCore',
    ...
    icon: 'Users',
    items: [
      { label: 'Visão geral RH', path: '/rh', icon: 'LayoutDashboard', feature: 'RH.VIEW' },
      { label: 'Funcionários', path: '/rh/funcionarios', icon: 'Users', feature: 'RH.FUNCIONARIOS_VIEW' },
      { label: 'Departamentos', path: '/rh/departamentos', icon: 'Building2', feature: 'RH.DEPARTAMENTOS_VIEW' },
      { label: 'Cargos', path: '/rh/cargos', icon: 'UserCog', feature: 'RH.CARGOS_VIEW' },
      { label: 'Jornadas', path: '/rh/jornadas', icon: 'Timer', feature: 'RH.JORNADAS_VIEW' },
      { label: 'Escalas', path: '/rh/escalas', icon: 'ClipboardList', feature: 'RH.ESCALAS_VIEW' },
      { label: 'Documentos', path: '/rh/documentos', icon: 'FileText', feature: 'RH.DOCUMENTOS_VIEW' },
      { label: 'Consentimentos LGPD', path: '/rh/consentimentos', icon: 'ShieldCheck', feature: 'RH.CONSENTIMENTOS_VIEW' },
      { label: 'Marcações de ponto', path: '/rh-ponto/marcacoes', icon: 'CheckSquare', feature: 'RH.PONTO_VIEW' },
      { label: 'Banco de horas', path: '/rh-ponto/banco-horas', icon: 'Wallet', feature: 'RH.BANCOHORAS_VIEW' },
      { label: 'Ajustes', path: '/rh-ponto/ajustes', icon: 'AlertTriangle', feature: 'RH.PONTO_AJUSTAR' },
      { label: 'Justificativas', path: '/rh-ponto/justificativas', icon: 'FileText', feature: 'RH.PONTO_JUSTIFICAR' },
      { label: 'Fechamentos', path: '/rh-ponto/fechamentos', icon: 'CheckCircle2', feature: 'RH.PONTO_FECHAR' },
      { label: 'Totem de Ponto', path: '/totem-rh', icon: 'Fingerprint', feature: 'RH.PONTO_MARCAR' },
      { label: 'Totem — Configuração', path: '/rh-ponto/configuracoes', icon: 'Settings', feature: 'RH.PONTO_FECHAR' },
      { label: 'Cartão de ponto', path: '/rh-ponto/cartao', icon: 'ListOrdered', feature: 'RH.PONTO_VIEW' },
      { label: 'Biometria Digital', path: '/rh/biometria', icon: 'Fingerprint', feature: 'RH.BIOMETRY_VIEW' },
      { label: 'Biometria Facial', path: '/rh/biometria-facial', icon: 'ScanFace', feature: 'RH.BIOMETRY_VIEW' },
      { label: 'Laboratório Biométrico', path: '/rh/biometric-lab', icon: 'Cpu', feature: 'RH.PONTO_VIEW', requireGestor: true },
      { label: 'Dashboard RH', path: '/rh/dashboard', icon: 'Activity', feature: 'RH.VIEW' },
      { label: 'Divergências', path: '/rh/divergencias', icon: 'AlertTriangle', feature: 'RH.PONTO_DIVERGENCIAS' },
      { label: 'Assinaturas digitais', path: '/rh/assinaturas', icon: 'FileSignature', feature: 'RH.PONTO_ASSINAR' },
      { label: 'Portal do Funcionário', path: '/rh/portal', icon: 'User2', feature: 'RH.PORTAL_VIEW' },
    ],
  },
  {
    section: 'adminSaaS',
  ...
  { macroTitle: 'Comercial' },
  {
    ...
    items: [
      ...
      { label: 'Caixa do Motoqueiro', path: '/caixa-motoqueiro', icon: 'Bike', feature: 'FOOD_SERVICE.DELIVERY_VIEW' },
